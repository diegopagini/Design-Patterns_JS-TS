...
class State1 {
	print(ball) {
		ball.ctx.clearRect(0, 0, ball.width, ball.height); // Limpiar toda la pantalla del canvas.
		ball.ctx.fillRect(ball.positionX, ball.positionY, ball.ballSize, ball.ballSize); // Para pintar la pelota.
